...
export const authorsHasErrored = bool => ({ type: AUTHORS_HAS_ERRORED, hasErrored: bool });
export const authorsIsLoading = bool => ({ type: AUTHORS_IS_LOADING, isLoading: bool });
export const authorsFetchDataSuccess = authors => ({ type: AUTHORS_FETCH_DATA_SUCCESS, authors });
